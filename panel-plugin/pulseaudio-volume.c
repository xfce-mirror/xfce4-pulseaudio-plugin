...
static void pulseaudio_volume_free_device_info (gpointer data)
{
...
pulseaudio_volume_init (PulseaudioVolume *volume)
{
  ...
  volume->sinks = g_hash_table_new_full (g_str_hash, g_str_equal, (GDestroyNotify)g_free, (GDestroyNotify)pulseaudio_volume_free_device_info);
  volume->sources = g_hash_table_new_full (g_str_hash, g_str_equal, (GDestroyNotify)g_free, (GDestroyNotify)pulseaudio_volume_free_device_info);
                                    ...
                                    void               *userdata)
{
  ...
  device_info = (PulseAudioDeviceInfo *) g_malloc (sizeof (PulseAudioDeviceInfo));
...
static gchar *pulseaudio_volume_get_description (GHashTable  *hash_table,
                                                 const gchar *key,
                                                 gboolean    *available)
{
